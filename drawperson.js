function drawpersons(subfeatur){
    ...
    .append("div")
        ...
        .append("circle")
            ...
            .on("mousemove", function(d){return (tooltip2.html("Scene:2"+"<br>"+"Class:HC"+"<br>Range:"+d.path[0]["__data__"].key+"<br> Value:"+d.path[0]["__data__"].value)).style("top", (event.pageY-150)+"px").style("left",(event.pageX-150)+"px");})
